...
from auxiliary_functions import load_data_from_csv, answer_question_from_csv
...
with st.sidebar:
    ...
    st.caption("<p style ='text-align:center'> made with ❤️ by Saif</p>",unsafe_allow_html=True )
...
if st.session_state.clicked[1]:
    ...
    with tab2:
        ...
        llm = ChatOpenAI(model_name="gpt-4-1106-preview", openai_api_key=apikey)
